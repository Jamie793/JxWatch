...
void setup_scr_screen_main(lv_ui *ui)
{
	...
	ui->screen_main_meter_battery = lv_meter_create(ui->screen_main_tileview_main_tile);
	...
	ui->screen_main_chart_heart = lv_chart_create(ui->screen_main_tileview_main_tile);
	...
	ui->screen_main_label_bluetooth = lv_label_create(ui->screen_main_tileview_main_tile);
	...
	ui->screen_main_label_wifi = lv_label_create(ui->screen_main_tileview_main_tile);
