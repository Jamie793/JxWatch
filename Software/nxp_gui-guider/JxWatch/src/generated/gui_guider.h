...
typedef struct
{
	...
	lv_obj_t *screen_meter_battery;
	lv_meter_scale_t *screen_meter_battery_scale_0;
	lv_meter_indicator_t *screen_meter_battery_scale_0_ndline_0;
	lv_obj_t *screen_chart_heart;
	lv_chart_series_t *screen_chart_heart_0;
	...
	lv_obj_t *screen_label_weather_sub;
	lv_obj_t *screen_label_weather_main;
