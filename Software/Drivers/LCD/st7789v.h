...
typedef enum
{
	...
	ST7789V_CMD_ReadDisplayID = 0x04,  /* Read Display ID */
	ST7789V_CMD_RDDID = 0x09, /* Read Display Status */
	ST7789V_CMD_ReadDisplayStatus = 0x0A, /*  Read Display Power Mode */
	ST7789V_CMD_RDDPM = 0x0B, /* Read Display MADCTL */
	ST7789V_CMD_RDDMADCTL = 0x0C, /* Read Display Pixel Format */
	ST7789V_CMD_RDDCOLMOD = 0x0D, /* Read Display Image Mode */
	ST7789V_CMD_RDDIM = 0x0E, /* Read Display Signal Mode */
	ST7789V_CMD_RDDSM = 0x0F, /* Read Display Self-Diagnostic Result */
