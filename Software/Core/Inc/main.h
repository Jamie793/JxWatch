...
#define ESP_HSPI_CS_GPIO_Port GPIOB
#define ESP_EN_Pin GPIO_PIN_13
#define ESP_EN_GPIO_Port GPIOB
#define LCD_TP_RST_Pin GPIO_PIN_8
#define LCD_TP_RST_GPIO_Port GPIOA
#define LED_TP_SCK_Pin GPIO_PIN_9
#define LED_TP_SCK_GPIO_Port GPIOA
#define LED_TP_SDA_Pin GPIO_PIN_10
#define LED_TP_SDA_GPIO_Port GPIOA
#define LCD_TP_TINT_Pin GPIO_PIN_11
#define LCD_TP_TINT_GPIO_Port GPIOA
#define LCD_TP_TINT_EXTI_IRQn EXTI15_10_IRQn
